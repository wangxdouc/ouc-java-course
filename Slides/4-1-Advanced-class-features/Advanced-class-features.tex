...
\author{王晓东}
\titlegraphic{\vspace{-5em}\includegraphics[height=8cm]{static/ouc.pdf}\vspace{-6em}}
...
匿名内部类是局部类的一种简化。{\kai 当我们只在一处使用到某个类型时，可
  以将之定义为局部类，进而如果我们只是创建并使用该类的一个实例的话，那
  么连类的名字都可以省略。}
\end{frame}
...
\samp{JavaSE\_03/TestAnonymousInnerClass.java}
...
\samp{JavaSE\_03/TestAnonymousInnerClass02.java}
